...
import com.hulo.chatwithimaginaryfriends.adapter.ComboBoxBotAdapter;
import com.hulo.chatwithimaginaryfriends.adapter.ComboBoxHeartAdapter;
...
public class AddEditCharacterActivity extends AppCompatActivity {
    ...
    private void selectValue(Spinner spinner, BotModel value) {
        for (int i = 0; i < spinner.getCount(); i++) {
            ...
            if (value.getId().equals(bot.getId())) {
                spinner.setSelection(i);
                break;
            }
        }
